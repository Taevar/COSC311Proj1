...
public class Student {
	...
	public void delete(RandomAccessFile raFile) throws IOException {
		readFromFile(raFile);
		fName = pad("deleted", LENGTH);
		writeToFile(raFile);
	}
	
	public boolean isDeleted(RandomAccessFile raFile) throws IOException {
		return fName.trim().equals("deleted");
	}


	public void modifyRec(RandomAccessFile raFile, String first, String last, int IDnum, double GPAnum) throws IOException {
		if (!first.equals(""))
